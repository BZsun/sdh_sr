...
parser.add_argument('--testroot', default="data/test", type=str, help='path to dataset')
...
parser.add_argument('--outf', default='sr/', help='folder to output images')
parser.add_argument('--manualSeed', type=int, help='manual seed')
parser.add_argument("--pretrained", default="model/sr_model_epoch_50_iter_0.pth", type=str, help="path to pretrained model (default: none)")
...
test_set = ImageDatasetFromFile(test_list, opt.testroot,
                  ...
                  is_gray=False,upscale=opt.upscale)
