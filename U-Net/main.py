...
parser.add_argument('--data_root', default="data/main_face128", type=str, help='path to dataset')
...
def main():
    ...
    loss_data = open('loss_face.csv','a',newline='')
    ...
    for epoch in range(opt.start_epoch, opt.nEpochs + 1):  
        for iteration, batch in enumerate(train_data_loader, 0):
            ...
            prediction = forward_parallel(unet,input,opt.ngpu)
